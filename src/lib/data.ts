...
export const personalInfo = {
  ...
  experience: [
    {
      ...
      points: [
        ...
        "Automated Terraform plan analysis & SQL generation using LangChain + Vercel AI SDK, cutting infra provisioning time by 50%.",
  ...
  hobbies: [
    { name: "Gym & Fitness", emoji: "💪", description: "Consistent gym routine focusing on strength training." },
    { name: "Guitar", emoji: "🎸", description: "Learning and playing acoustic guitar in free time." },
    { name: "Tech Writing", emoji: "✍️", description: "Writing technical blogs and sharing knowledge with the dev community." },
  ],
  oss: [
    {
